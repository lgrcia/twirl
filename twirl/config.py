...
class ConfigManager:
    def __init__(self):
        ...
        self.catalog_path = self.folder_path / "gaia_14.fits.gz"
    ...
    def download_catalog(self):
        ...
        catalog_filename = 'lt14gmag-result.fits.gz'

        catalog = requests.get(
            "https://github.com/lgrcia/twirl-catalogs/raw/master/" + catalog_filename,
        ).content
    ...
    def load_catalog(self):
        ...
        if self.current_catalog is None:
            ...
            self.current_catalog = np.array([
                gaia_sources["ra"].data,
                gaia_sources["dec"].data
            ]).T
